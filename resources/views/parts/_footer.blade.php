        ...
        <div class="col-xs-12  col-md-4 col-md-offset-1">
            <div class="widget-contact  push-down-30">
                ...
                <span class="widget-contact__text">
                    <span class="widget-contact__title">Юлия Алхимов</span>
                    <br>Email: <a href="mailto:dima@932433.ru">julka@mail.ru</a>
                    <br>VK: <a href="https://vk.com/dyuryev84" target="_blank">https://vk.com/</a>
                    </span>
            </div>
        </div>
    </div>
